...
let SimplrCard = class SimplrCard extends SimplrComponentBase {
    constructor() {
        super();
...
], SimplrCard.prototype, "label", void 0);
__decorate([
    Property({ reflect: true })
], SimplrCard.prototype, "subtitle", void 0);
SimplrCard = __decorate([
    CustomElement('simplr-card')
], SimplrCard);
export default SimplrCard;
