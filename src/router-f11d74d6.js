 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const O=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),M=` ${w} `;class R{constructor(t,e,i,n){this.strings=t,this.values=e,this.type=i,this.processor=n}getHTML(){const t=this.strings.length-1;let e="",i=!1;for(let n=0;n<t;n++){const t=this.strings[n],s=t.lastIndexOf("\x3c!--");i=(s>-1||i)&&-1===t.indexOf("--\x3e",s+1);const r=x.exec(t);e+=null===r?t+(i?M:f):t.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+w}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==O&&(e=O.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function W(t){let e=Z.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},Z.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const n=t.strings.join(w);return i=e.keyString.get(n),void 0===i&&(i=new _(t,t.getTemplateElement()),e.keyString.set(n,i)),e.stringsArray.set(t.strings,i),i}const Z=new Map,J=new WeakMap,X=(t,e,i)=>{let n=J.get(e);void 0===n&&(g(e,e.firstChild),J.set(e,n=new j(Object.assign({templateFactory:W},i))),n.appendInto(e)),n.setValue(t),n.commit()};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,n){const s=e[0];if("."===s){return new z(t,e.slice(1),i).parts}if("@"===s)return[new I(t,e.slice(1),n.eventContext)];if("?"===s)return[new L(t,e.slice(1),i)];return new $(t,e,i).parts}handleTextExpression(t){return new j(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const K=(t,...e)=>new R(t,e,"html",G)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const pt={};class ut extends at{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight(((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t)),i),i=e(t,new Set),n=[];i.forEach((t=>n.unshift(t))),this._styles=n}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!lt){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new dt(String(e),ht)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?lt?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==pt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return pt}}function mt(){return window.location.href.includes("github.io")?"/simplr-website-v2/":"/"}ut.finalized=!0,ut.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const n=i.scopeName,s=J.has(e),r=Y&&11===e.nodeType&&!!e.host,o=r&&!it.has(n),a=o?document.createDocumentFragment():e;if(X(t,a,Object.assign({templateFactory:tt(n)},i)),o){const t=J.get(a);J.delete(a);const i=t.value instanceof k?t.value.template:void 0;nt(n,a,i),g(e,e.firstChild),e.appendChild(a),J.set(e,t)}!s&&r&&window.ShadyCSS.styleElement(e.host)};class gt extends ut{static get properties(){return{mobileopen:{type:Boolean,reflect:!0}}}constructor(){super(),this.mobileopen=!1}toggleMobileMenu(){this.mobileopen&&(this.mobileopen=!1)}render(){return K`
            ...
            <nav class="links">
                <a @click=${this.toggleMobileMenu} id="mobile-home" href="${mt()}">Home</a>
                <a @click=${this.toggleMobileMenu} href="${mt()}development">Development</a>
                <a @click=${this.toggleMobileMenu} href="${mt()}consulting">Consulting</a>
                <a @click=${this.toggleMobileMenu} href="${mt()}contact">Contact</a>
            </nav>
            <button @click=${()=>this.mobileopen=!0} class="mobile-open">☰</button>
        `}getStyles(){return ct`
            :host {
                position: absolute;
                top: 0;
